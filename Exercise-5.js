...
console.log (exampleFirstWord4 + ', ' + 'with length: ' + firstWordLength);
console.log (secondWord4 + ', ' + 'with length: ' + secondWordLength);
console.log (thirdWord4 + ', ' + 'with length: ' + thirdWord4Length);
console.log (fourthWord4 + ', ' + 'with length: ' + fourthWord4Length);
console.log (fifthWord4 + ', ' + 'with length: ' + fifthWord4Length);
